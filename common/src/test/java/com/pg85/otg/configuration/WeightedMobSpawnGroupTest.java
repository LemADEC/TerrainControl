...
import static com.pg85.otg.configuration.WeightedMobSpawnGroup.fromJson;
import static com.pg85.otg.configuration.WeightedMobSpawnGroup.toJson;
...
public class WeightedMobSpawnGroupTest
{
    ...
    public void testSerialization() throws InvalidConfigException
    {
        ...
        Assert.assertEquals(groups, WeightedMobSpawnGroup.fromJson(WeightedMobSpawnGroup.toJson(groups)));
    }
    ...
    public void testMalformedJSON() throws InvalidConfigException
    {
        ...
        for (String test : tests)
        {
            try
            {
                WeightedMobSpawnGroup.fromJson(test);
