...
public class FileSettingsReaderTest
{
    ...
    public String fileContentsString = "Author: OTG\n"
            + "\n"
    ...
    public void testReading() throws IOException
    {
        ...
        assertEquals("OTG", settingsMap.getSetting(WorldStandardValues.AUTHOR));
        ...
        assertEquals("Author: OTG", it.next().getRawValue());
