...
import com.pg85.otg.customobjects.UseBiome;
...
public class BiomeConfig extends ConfigFile
{
    ...
    protected void readConfigSettings(SettingsMap settings)
    {
        ...
        this.woodLandMansionsEnabled = settings.getSetting(BiomeStandardValues.MANSIONS_ENABLED,
                                                           defaultSettings.defaultWoodlandMansions);
    ...
    protected void writeConfigSettings(SettingsMap writer)
    {
        ...
        writer.putSetting(BiomeStandardValues.MANSIONS_ENABLED, woodLandMansionsEnabled,
