...
public class CustomObjectManager
{
    ...
    public void loadGlobalObjects()
    {
        ...
        this.globalCustomObjects.load(this.loaders, OTG.getEngine().getGlobalObjectsDirectory());
        OTG.log(LogMarker.INFO, "{} Global custom objects loaded", globalCustomObjects.getAll().size());
    }
