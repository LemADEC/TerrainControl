...
public class BO3Loader implements CustomObjectLoader
{
    ...
    public BO3Loader()
    {
        ...
        ConfigFunctionsManager registry = OTG.getConfigFunctionsManager();
    ...
    public static NamedBinaryTag loadMetadata(String name, File bo3Folder)
    {
        ...
        OTG.log(LogMarker.WARN, "Invalid NBT specification: {}", name);
        return null;
    }
    ...
    private static NamedBinaryTag loadNBTFromString(String string)
    {
        try
        {
            return OTG.getEngine().toNamedBinaryTag(string);
        } catch (InvalidConfigException e)
        {
            OTG.log(LogMarker.WARN, "Could not parse as NBT: {}", string);
            return null;
        }
    }
    ...
    private static NamedBinaryTag loadNBTFromTextFile(File file)
    {
        ...
        {
            OTG.log(LogMarker.WARN, "Could not read file " + file + ": " + e.getLocalizedMessage());
            return null;
        }
    }
    ...
    private static NamedBinaryTag findCorrectTag(NamedBinaryTag rootTag)
    {
        ...
        OTG.log(LogMarker.WARN, "Structure of NBT file is incorrect.");
        return null;
    }
