...
public class OTGPlugin extends JavaPlugin
{
    ...
    public ChunkGenerator getDefaultWorldGenerator(String worldName, String id)
    {
        ...
        {
            OTG.log(LogMarker.DEBUG, "Ignoring empty world name. Is some generator plugin checking if \"OTG\" is a valid world name?");
        ...
        OTG.log(LogMarker.INFO, "Starting to enable world ''{}''...", (Object) worldName);
