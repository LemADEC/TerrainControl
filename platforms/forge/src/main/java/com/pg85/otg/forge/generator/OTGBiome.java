...
public class OTGBiome extends Biome
{
    ...
    public static Biome getOrCreateBiome(BiomeConfig biomeConfig, BiomeIds biomeIds)
    {
        ...
        final OTGBiome customBiome = new OTGBiome(biomeConfig, biomeIds);
        customBiome.setRegistryName(registryKey);

        final ForgeEngine forgeEngine = ((ForgeEngine) OTG.getEngine());
        ...
        if (biomeIds.isVirtual())
        {
            ...
            } else
            {
                ...
                OTG.log(LogMarker.DEBUG, ",{},{},{}", registryKey, savedBiomeId, generationBiomeId);
            }
        } else if (savedBiomeId < 256)
        {
            ...
            OTG.log(LogMarker.DEBUG, ",{},{},{}", biomeConfig.getName(), savedBiomeId, biomeIds.getGenerationId());
        }
