...
import com.pg85.otg.forge.feature.RandomPlantStateGenerator;
...
public class ForgeWorld implements LocalWorld
{
    ...
    {
        final Biome biome = OTGBiome.getOrCreateBiome(biomeConfig, biomeIds);
    ...
    public LocalBiome getBiomeByName(String name) throws BiomeNotFoundException
    {
        ...
        if (biome == null)
        {
            OTG.log(LogMarker.INFO, "No biome found with name '" + name + "'. Skipping...");
        }
        return biome;
    }
    ...
    public void provideWorldInstance(WorldServer world)
    {
        ...
        this.mansionGen = new OTGMansionGen(configs);
        ...
        this.rareBuildingGen = (OTGRareBuildingGen)net.minecraftforge.event.terraingen.TerrainGen.getModdedMapGen(this.rareBuildingGen, net.minecraftforge.event.terraingen.InitMapGenEvent.EventType.SCATTERED_FEATURE);
        this.strongholdGen = (OTGStrongholdGen)net.minecraftforge.event.terraingen.TerrainGen.getModdedMapGen(this.strongholdGen, net.minecraftforge.event.terraingen.InitMapGenEvent.EventType.STRONGHOLD);
        this.villageGen = (OTGVillageGen)net.minecraftforge.event.terraingen.TerrainGen.getModdedMapGen(this.villageGen, net.minecraftforge.event.terraingen.InitMapGenEvent.EventType.VILLAGE);
        this.mineshaftGen = (OTGMineshaftGen)net.minecraftforge.event.terraingen.TerrainGen.getModdedMapGen(this.mineshaftGen, net.minecraftforge.event.terraingen.InitMapGenEvent.EventType.MINESHAFT);
        this.oceanMonumentGen = (OTGOceanMonumentGen)net.minecraftforge.event.terraingen.TerrainGen.getModdedMapGen(this.oceanMonumentGen, net.minecraftforge.event.terraingen.InitMapGenEvent.EventType.OCEAN_MONUMENT);
    ...
    private Entity createEntity(ResourceLocation entityResource, NBTTagCompound optionalMeta)
    {
        ...
        if (entityClass == null)
        {
            OTG.log(LogMarker.WARN, "Unknown entity name: {}", entityResource);
            return null;
        }
