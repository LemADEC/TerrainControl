...
public class NBTHelper
{
        ...
        for (int i = 0; i < nmsListTag.tagCount(); i++)
        {
            ...
            switch (listType)
            {
                ...
                case TAG_Compound:
                    ...
                    break;
                default:
                    OTG.log(LogMarker.INFO, "Cannot convert list subtype {} from it's NMS value", listType);
                    break;
            }
        }
        return listTag;
    ...
    /**
     * Converts a OTG NBT list tag into an net.minecraft.server NBT
     * list tag.
     *
     * @param listTag The OTG list tag.
